...
def add_cross_view_config(parser: argparse.ArgumentParser):
    ...
    group.add_argument("--cross_view_3d_noise_prior_mode", type=str, choices=["none", "scene_action_grid"], default="none", help="Stage2-only 3D-token structured noise prior mode.")
