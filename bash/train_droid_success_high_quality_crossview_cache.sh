...
echo "CROSS_VIEW_USE_KEYFRAME_ANCHOR=$CROSS_VIEW_USE_KEYFRAME_ANCHOR"
echo "KEYFRAME_ANCHOR_MANIFEST_TRAIN=$KEYFRAME_ANCHOR_MANIFEST_TRAIN"
echo "KEYFRAME_ANCHOR_MANIFEST_VAL=$KEYFRAME_ANCHOR_MANIFEST_VAL"
